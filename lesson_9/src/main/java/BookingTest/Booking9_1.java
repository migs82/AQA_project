...
java.util.Date sDate = new java.util.Date();
    ...
    long strDateDeparture = newDay + secDay * 8;
        ...
        @FindBy(xpath = ".//div[@id='filter_price']//a[1]")
                private WebElement sortByPrice;
        @FindBy(xpath = ".//li[contains(@class,'sort_bayesian_review_score')]")
        private WebElement sortByRanc;
        @FindBy(xpath = "//div[2]//div[2]//div[2]//div[1]//div[1]//div[1]//div[1]//div[2]//div[2]//div[2]//span[1]")
        private WebElement selectRoom;

    public Booking9_1(WebDriver driver) {
